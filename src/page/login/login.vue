<template>
    <div id="login-view">
        <div class="login-region">
            <div class="login-input login-title">we_match后台管理</div>
...
<style>
#login-view{
    background-image: url('https://wematch-1324086347.cos.accelerate.myqcloud.com/We_Match/pc-background.png');
